...
如果不知道要選擇那一個版本，建議使用 CJK JP 版本，效果會最好。

Regular style 預覽
![馬路口圓體 Regular 預覽](https://github.com/max32002/maruko-gothic/raw/main/preview/maruko-cjktc-banner.jpg)

Medium style 預覽
![馬路口圓體 Medium 預覽](https://github.com/max32002/maruko-gothic/raw/main/preview/maruko-cjktc-banner-medium.jpg)

Light style 預覽
![馬路口圓體 Medium 預覽](https://github.com/max32002/maruko-gothic/raw/main/preview/maruko-cjktc-banner-light.jpg)
...
@font-face {
  ...
  src: url(https://cdn.jsdelivr.net/gh/max32002/maruko-gothic@1.015/webfont/CJK%20JP/MarukoGothicCJKjp-Regular.woff2) format("woff2");
}
@font-face {
  font-family: MarukoGothicCJKtc-Regular;
  src: url(https://cdn.jsdelivr.net/gh/max32002/maruko-gothic@1.015/webfont/CJK%20TC/MarukoGothicCJKtc-Regular.woff2) format("woff2");
}
@font-face {
  font-family: MarukoGothicCJKsc-Regular;
  src: url(https://cdn.jsdelivr.net/gh/max32002/maruko-gothic@1.015/webfont/CJK%20SC/MarukoGothicCJKsc-Regular.woff2) format("woff2");
}
```
...
@font-face {
  ...
  src: url(https://cdn.jsdelivr.net/gh/max32002/maruko-gothic@1.015/webfont/CJK%20JP/MarukoGothicCJKjp-Medium.woff2) format("woff2");
}
@font-face {
  font-family: MarukoGothicCJKtc-Medium;
  src: url(https://cdn.jsdelivr.net/gh/max32002/maruko-gothic@1.015/webfont/CJK%20TC/MarukoGothicCJKtc-Medium.woff2) format("woff2");
}
@font-face {
  font-family: MarukoGothicCJKsc-Medium;
  src: url(https://cdn.jsdelivr.net/gh/max32002/maruko-gothic@1.015/webfont/CJK%20SC/MarukoGothicCJKsc-Medium.woff2) format("woff2");
}
```
...
@font-face {
  ...
  src: url(https://cdn.jsdelivr.net/gh/max32002/maruko-gothic@1.015/webfont/CJK%20JP/MarukoGothicCJKjp-Light.woff2) format("woff2");
}
@font-face {
  font-family: MarukoGothicCJKtc-Light;
  src: url(https://cdn.jsdelivr.net/gh/max32002/maruko-gothic@1.015/webfont/CJK%20TC/MarukoGothicCJKtc-Light.woff2) format("woff2");
}
@font-face {
  font-family: MarukoGothicCJKsc-Light;
  src: url(https://cdn.jsdelivr.net/gh/max32002/maruko-gothic@1.015/webfont/CJK%20SC/MarukoGothicCJKsc-Light.woff2) format("woff2");
}
```
...
```
@font-face {
  font-family: MarukoGothicCJKjp-Bold;
  src: url(https://cdn.jsdelivr.net/gh/max32002/maruko-gothic@1.015/webfont/CJK%20JP/MarukoGothicCJKjp-Bold.woff2) format("woff2");
}
```
...
```
@font-face {
  font-family: MarukoGothicCJKjp-Black;
  src: url(https://cdn.jsdelivr.net/gh/max32002/maruko-gothic@1.015/webfont/CJK%20JP/MarukoGothicCJKjp-Black.woff2) format("woff2");
}
```
